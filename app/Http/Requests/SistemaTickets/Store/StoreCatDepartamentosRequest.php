...
class StoreCatDepartamentosRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'descripcion' => 'required|string| unique:cat_departamentos,descripcion',
            'habilitado' => 'required',
    ...
    public function messages(): array
    {
        return [
            ...
            'descripcion.string' => 'El campo descripción departamento debe ser una cadena de texto.',
             'descripcion.unique' => 'El departamento ya existe',
