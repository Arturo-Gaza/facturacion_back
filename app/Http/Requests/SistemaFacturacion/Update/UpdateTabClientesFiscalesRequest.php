...
namespace App\Http\Requests\SistemaFacturacion\Update;

use Illuminate\Contracts\Validation\Validator;
use Illuminate\Foundation\Http\FormRequest;
use Illuminate\Http\Exceptions\HttpResponseException;

class UpdateTabClientesFiscalesRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'rfc' => 'nullable|string|max:20|unique:clientes_fiscales,rfc,' . $id . ',id_fiscal',
            'curp' => 'nullable|string|max:20|unique:clientes_fiscales,curp,' . $id . ',id_fiscal',
            'id_regimen' => 'required|exists:cat_regimenes_fiscales,id_regimen',
            'fecha_inicio_op' => 'nullable|date',
            'id_estatus_sat' => 'required|exists:cat_estatuses_sat,id_estatuses_sat',
