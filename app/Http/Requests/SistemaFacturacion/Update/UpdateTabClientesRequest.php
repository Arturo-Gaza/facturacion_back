...
class UpdateTabClientesRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'usuario' => 'required|string|max:100|unique:clientes,usuario,' . $this->route('id') . ',id_cliente',
            'password' => 'nullable|string|min:6|max:100',
            'email' => 'required|email|unique:clientes,email,' . $this->route('id') . ',id_cliente',
