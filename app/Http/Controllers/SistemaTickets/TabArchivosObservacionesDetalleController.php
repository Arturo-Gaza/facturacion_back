...
class TabArchivosObservacionesDetalleController extends Controller
{
    protected $_archivoRepo;

    public function __construct(TabArchivosObservacionesDetalleRepositoryInterface $archivoRepo)
    {
    ...
    public function store(Request $request)
    {
        ...
        try {
            $data = [
                'id_observacion_detalle' => $request->id_observacion_detalle,
