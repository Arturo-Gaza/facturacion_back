...
// Subconsulta para conteo1Totals
$conteo1Totals = DB::table('tab_conteo as a')
    ->join('users as u', 'u.id', '=', 'a.id_usuario')
    ->select(
        'a.id_producto',
        'a.id_ubicacion',
        'a.ubicacion',
        DB::raw('SUM(a.cantidad) AS total_conteo1'),
        'u.user'
    )
    ->where('a.id_carga', $idCarga)
    ->where('a.conteo', $conteo1)
    ->groupBy('a.id_ubicacion','ubicacion','a.id_producto', 'u.user');

// Subconsulta para conteo2Totals
$conteo2Totals = DB::table('tab_conteo as a')
    ->join('users as u', 'u.id', '=', 'a.id_usuario')
    ->select(
        'a.id_producto',
        'a.id_ubicacion',
        'a.ubicacion',
        DB::raw('SUM(a.cantidad) AS total_conteo2'),
        'u.user'
    )
    ->where('a.id_carga', $idCarga)
    ->where('a.conteo', $conteo2)
    ->groupBy('a.id_ubicacion','ubicacion','a.id_producto', 'u.user');

// Subconsulta para conteo3Totals
$conteo3Totals = DB::table('tab_conteo as a')
    ->join('users as u', 'u.id', '=', 'a.id_usuario')
    ->select(
        'a.id_producto',
        'a.id_ubicacion',
        'a.ubicacion',
        DB::raw('SUM(a.cantidad) AS total_conteo3'),
        'u.user'
    )
    ->where('a.id_carga', $idCarga)
    ->where('a.conteo', $conteo3)
    ->groupBy('a.id_ubicacion','ubicacion','a.id_producto', 'u.user');
...
$query = DB::table('tab_conteo as a')
    ...
    ->groupBy(
        ...
        'conteo3.user',
        'conteo1.id_producto',
        'conteo1.id_ubicacion',
        'conteo1.ubicacion',
        'conteo2.id_producto',
        'conteo2.id_ubicacion',
        'conteo2.ubicacion',
        'conteo3.id_producto',
        'conteo3.id_ubicacion',
        'conteo3.ubicacion'
    )->orderBy('a.ubicacion','asc')->orderBy('a.codigo','asc')
    ->get();
        return response()->json($query);
    }
}
